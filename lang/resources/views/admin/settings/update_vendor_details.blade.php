                                ...
                                <form class="forms-sample" action="{{ url('admin/update-vendor-details/personal') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="vendor_address"
                                            ...
                                            value="{{ $vendorDetails['address'] }}"> {{-- $vendorDetails was passed from AdminController --}}
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_city">City</label>
                                        <input type="text" class="form-control" id="vendor_city" placeholder="Enter City"
                                            name="vendor_city" value="{{ $vendorDetails['city'] }}"> {{-- $vendorDetails was passed from AdminController --}}
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_state">State</label>
                                        <input type="text" class="form-control" id="vendor_state"
                                            placeholder="Enter State" name="vendor_state"
                                            value="{{ $vendorDetails['state'] }}"> {{-- $vendorDetails was passed from AdminController --}}
                                    </div>
                                        ...
                                        <select class="form-control" id="vendor_country" name="vendor_country"
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country['name'] }}"
                                                    @if ($country['name'] == $vendorDetails['country']) selected @endif>
                                                    {{ $country['name'] }}</option>
                                            @endforeach
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="vendor_pincode"
                                            ...
                                            value="{{ $vendorDetails['pincode'] }}"> {{-- $vendorDetails was passed from AdminController --}}
                                    </div>
                                    <div class="form-group">
                                ...
                                <form class="forms-sample" action="{{ url('admin/update-vendor-details/business') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="shop_country" name="shop_country"
                                            ...
                                            @foreach ($countries as $country)
                                                <option value="{{ $country['name'] }}"
                                                    @if (isset($vendorDetails['shop_country']) && $country['name'] == $vendorDetails['shop_country']) selected @endif>
                                                    {{ $country['name'] }}</option>
                                            @endforeach
