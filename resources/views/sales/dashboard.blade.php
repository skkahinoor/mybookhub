        ...
        <div class="row mb-4">
            <div class="col-12">
                <div class="d-flex justify-content-between align-items-center">
                    <div>
                        <h2 class="page-title mb-0">Welcome, {{ Auth::guard('sales')->user()->name ?? 'Sales Executive' }}
                        </h2>
        ...
        <div class="row g-4 mb-4">
            @if (auth('sales')->user()->can('view_students'))
                <div class="col-md-6 col-lg-4">
                    <div class="card shadow-sm border-0 h-100 text-white" style="background-color: rgb(83 155 122)"
                        !important>
                        <div class="card-body">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div>
                                    ...
                                    <small class="mt-2 opacity-75 d-block">{{ number_format($todayStudents ?? 0) }} students
                                        enrolled today</small>
                                </div>
                                <div class="bg-secondary bg-opacity-20 rounded-circle p-3">
                ...
                <div class="col-md-3">
                    <div class="card shadow-sm border-0 h-100 bg-info text-white">
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div>
                                    <p class="mb-1 opacity-75 small">Wallet Balance</p>
                                    <h2 class="fw-bold mb-0">
                                        ₹{{ number_format(Auth::guard('sales')->user()->wallet_balance ?? 0, 2) }}</h2>
                                    <small class="mt-2 opacity-75 d-block">Available for withdrawal</small>
                                </div>
                                <div class="bg-secondary bg-opacity-20 rounded-circle p-3">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between align-items-start mb-3">
                                <div>
                                    ...
                                    <small class="mt-2 opacity-75 d-block">{{ number_format($totalStudents ?? 0) }} total
                                        students</small>
                                </div>
                                <div class="bg-secondary bg-opacity-20 rounded-circle p-3">
