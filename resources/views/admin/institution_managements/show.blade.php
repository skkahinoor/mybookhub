                ...
                <div class="details-container">
                    ...
                    <div class="detail-row">
                        <div class="detail-group">
                            ...
                            <div class="detail-value">
                                {{ \App\Models\Category::find($institution->board)->category_name ?? $institution->board }}
                            </div>
                        </div>
                        <div class="detail-group">
                            <div class="detail-label">
                    ...
                    <div class="detail-row">
                        <div class="detail-group">
                            ...
                            <div class="detail-value">{{ $institution->country ? $institution->country->name : 'N/A' }}
                            </div>
                        </div>
                    ...
                    <div class="detail-row">
                        <div class="detail-group">
                            ...
                            <div class="detail-value">{{ $institution->district ? $institution->district->name : 'N/A' }}
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="detail-group">
                        ...
                        @if ($institution->status == 0)
                            <div class="text-danger">This institution is inactive. Please activate it to make it visible to
                                students.</div>
                        @endif
                    </div>
                            ...
                            <div class="detail-value">
                                @foreach ($institution->institutionClasses as $instClass)
                                    <div class="class-item">
                                        <div class="row">
                                            <div class="col-md-4">
                                                <div class="detail-label">Subcategory (Class)</div>
                                                <div class="detail-value">
                                                    {{ $instClass->subcategory->subcategory_name ?? 'N/A' }}</div>
                                            </div>
                                            <div class="col-md-4">
                    ...
                    <div class="detail-group text-center mt-4">
                        ...
                        <a href="{{ url('admin/institution-managements/' . $institution->id . '/edit') }}" class="btn-back"
                            style="background: #25836e; color: #fff; margin-left: 12px;">
