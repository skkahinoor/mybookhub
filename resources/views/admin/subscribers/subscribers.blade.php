                                        ...
                                        @foreach ($subscribers as $subscriber)
                                            <tr>
                                                ...
                                                <td>
                                                    ...
                                                    {{-- https://stackoverflow.com/questions/2487921/convert-a-date-format-in-php --}} {{-- https://www.php.net/manual/en/function.date.php#:~:text=date(%22-,F%20j%2C%20Y%2C%20g%3Ai%20a,-%22)%3B%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20%20//%20March --}}
                                                </td>
                                                <td>
                                                    @if ($adminType === 'vendor')
                                                        <a class="updateSubscriberStatus"
                                                            ...
                                                            data-url="{{ route('vendor.updatesubscriberstatus') }}"
                                                    ...
                                                    @else
                                                        @if ($subscriber['status'] == 1)
                                                            <a class="updateSubscriberStatus"
                                                                id="subscriber-{{ $subscriber['id'] }}"
                                                                subscriber_id="{{ $subscriber['id'] }}"
                                                                data-url="{{ route('admin.updatesubscriberstatus') }}"
                                                ...
                                                <td>
                                                    ...
                                                    <a href="javascript:void(0)" class="confirmDelete"
                                                        ...
                                                        data-url="{{ url('admin/delete-subscriber/' . $subscriber['id']) }}">
