...
@section('content')
    ...
    <style>
        ...
        .metric-card.vendors .metric-icon-wrapper {
        ...
        .metric-card.users .metric-icon-wrapper {
        ...
        .metric-card.subscribers .metric-icon-wrapper {
        ...
        .metric-card.products .metric-icon-wrapper {
        ...
        .metric-card.orders .metric-icon-wrapper {
        ...
        .metric-card.coupons .metric-icon-wrapper {
                                ...
                                @if ($userType === 'vendor' && $vendor)
                                    @if ($vendor->plan === 'pro')
                                        <span class="badge badge-primary ml-2"
                                            style="font-size: 0.75rem; border-radius: 6px;">PRO</span>
                                    @else
                                        <span class="badge badge-secondary ml-2"
                                            style="font-size: 0.75rem; border-radius: 6px;">FREE</span>
