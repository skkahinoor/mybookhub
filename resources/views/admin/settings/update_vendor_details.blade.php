                                ...
                                <form class="forms-sample" action="{{ url('admin/update-vendor-details/personal') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="vendor_address"
                                            ...
                                            value="{{ Auth::guard('admin')->user()->address }}"> {{-- Accessing Specific Guard Instances: https://laravel.com/docs/9.x/authentication#accessing-specific-guard-instances --}}
                                    </div>

                                    <div class="form-group">
                                        <label for="vendor_country">Country</label>
                                        <select class="form-control" id="vendor_country_id" name="country_id"
                                            style="color: #495057">
                                            <option value="">Select Country</option>
                                            @foreach ($countries as $country)
                                                <option value="{{ $country['id'] }}"
                                                    @if (isset(Auth::guard('admin')->user()->country_id) && $country['id'] == Auth::guard('admin')->user()->country_id) selected @endif>{{ $country['name'] }}
                                                </option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="vendor_state_id" name="state_id"
                                            style="color: #495057">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="vendor_district_id" name="district_id"
                                            style="color: #495057">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="vendor_block_id" name="block_id"
                                            style="color: #495057">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="vendor_pincode"
                                            ...
                                            value="{{ Auth::guard('admin')->user()->pincode }}"> {{-- Accessing Specific Guard Instances: https://laravel.com/docs/9.x/authentication#accessing-specific-guard-instances --}}
                                    </div>
                                    <div class="form-group">
                                        <label for="vendor_mobile">Mobile</label>
                                        <input type="text" class="form-control" id="vendor_mobile"
                                            placeholder="Enter 10 Digit Mobile Number" name="vendor_mobile"
                                            value="{{ Auth::guard('admin')->user()->mobile }}" maxlength="10"
                            ...
                            <div class="card-body">
                                ...
                                <form class="forms-sample" action="{{ url('admin/update-vendor-details/business') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" id="location_search" class="form-control mb-3"
                                            placeholder="Search location (Type name, street, city...)">
                                        <div id="map"
                                            style="height: 300px; width: 100%; border-radius: 10px; margin-bottom: 10px; border: 1px solid #ddd;">
                                        </div>
                                        <div class="row">
                                            <div class="col-md-6 mb-2">
                                                ...
                                                <input type="text" class="form-control" id="latitude"
                                                    ...
                                                    value="{{ $vendorDetails['latitude'] ?? '' }}" readonly>
                                            </div>
                                            <div class="col-md-6 mb-2">
                                                <label class="text-muted small">Longitude</label>
                                                <input type="text" class="form-control" id="longitude"
                                                    name="longitude" placeholder="Longitude"
                                                    value="{{ $vendorDetails['longitude'] ?? '' }}" readonly>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="business_country_id" name="country_id"
                                            style="color: #495057">
                                            <option value="">Select Country</option>
                                            @foreach ($countries as $country)
                                                <option value="{{ $country['id'] }}"
                                                    @if (isset($vendorDetails['country_id']) && $vendorDetails['country_id'] == $country['id']) selected @endif>
                                                    {{ $country['name'] }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="business_state_id" name="state_id"
                                            style="color: #495057">
                                            <option value="">Select State</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="business_district_id" name="district_id"
                                            style="color: #495057">
                                            <option value="">Select District</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="business_block_id" name="block_id"
                                            style="color: #495057">
                                            <option value="">Select Block</option>
                                        </select>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="gst_number"
                                            placeholder="Enter GST Number" name="gst_number"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="pan_number"
                                            placeholder="Enter PAN Number" name="pan_number"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" name="address_proof" id="address_proof">
                                            <option value="Passport" @if (isset($vendorDetails['address_proof']) && $vendorDetails['address_proof'] == 'Passport') selected @endif>
                                                Passport</option>
                                            ...
                                            <option value="PAN" @if (isset($vendorDetails['address_proof']) && $vendorDetails['address_proof'] == 'PAN') selected @endif>PAN
                                            </option>
                                ...
                                <form class="forms-sample" action="{{ url('admin/update-vendor-details/bank') }}"
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" id="bank_ifsc_code"
                                            placeholder="Enter Bank IFSC Code" name="bank_ifsc_code"
