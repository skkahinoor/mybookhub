    ...
    <section class="content-inner-1 py-5">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8">
                    <div class="thankyou-card text-center">
                        <div class="icon-wrap">
                            <svg width="64" height="64" viewBox="0 0 24 24" fill="none"
                                ...
                                <path
                                    ...
                                    fill="#e7f5e9" />
                                <path d="M9.00002 12.5L11 14.5L15 10.5" stroke="#28a745" stroke-width="2"
                                    stroke-linecap="round" stroke-linejoin="round" />
                            </svg>
                        </div>
                        <h2 class="title mb-2">Your order is confirmed!</h2>
                        <p class="subtitle mb-4">Thank you for shopping with us. A confirmation has been sent to your email.
                        </p>
                        ...
                        <div class="tips mt-4">
                            <small class="text-muted">Need help? <a href="{{ url('contact') }}" class="text-primary">Contact
                                    support</a></small>
                        </div>
                    </div>
                </div>
        ...
        <style>
            ...
            .thankyou-card::after {
                ...
                width: 180px;
                height: 180px;
                background: radial-gradient(circle at center, rgba(0, 123, 255, .15), rgba(0, 123, 255, 0) 70%);
                border-radius: 50%
            }
