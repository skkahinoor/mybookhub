...
Route::prefix('/vendor')->namespace('App\Http\Controllers\Admin')->group(function () {
    ...
    Route::group(['middleware' => ['vendor']], function () {
        ...
        Route::post('notifications/delete-all', [App\Http\Controllers\Admin\NotificationController::class, 'deleteAll'])->name('vendor.notifications.delete_all');
        ...
        Route::get('education-levels', [SectionController::class, 'sections'])->name('vendor.education_levels');
        Route::post('update-education-level-status', 'SectionController@updateSectionStatus')->name('vendor.updateeducationstatus');
        Route::get('delete-education/{id}', 'SectionController@deleteSection')->name('vendor.delete_education');
        Route::match(['get', 'post'], 'add-edit-education/{id?}', [SectionController::class, 'addEditSection'])->name('vendor.add_edit_education_level');
        ...
        Route::post('author_update/{id}', [AuthorController::class, 'update'])->name('vendor.update.author');
        Route::get('author_delete/{id}', [AuthorController::class, 'delete'])->name('vendor.delete.author');

        //RequestedBooks
        Route::get('requestedbooks', [BookRequestsController::class, 'index'])->name('vendor.requestbook.index');
        Route::match(['get', 'post'], 'requestedbooks/reply/{id}', [BookRequestsController::class, 'reply'])->name('vendor.requestbook.reply');
        ...
        Route::get('add_subject', [SubjectController::class, 'add'])->name('vendor.add.subject');
        Route::post('/vendor/store_subject', [SubjectController::class, 'store'])->name('vendor.store.subject');
        Route::get('edit/{id}', [SubjectController::class, 'edit'])->name('vendor.edit.subject');
        Route::post('update/{id}', [SubjectController::class, 'update'])->name('vendor.update.subject');
        Route::get('delete/{id}', [SubjectController::class, 'delete'])->name('vendor.delete.subject');
        ...
        Route::middleware(['vendor.plan'])->group(function () {
            ...
            Route::post('products/bulk-delete', [ProductsController::class, 'bulkDelete'])->name('vendor.products.bulkDelete');
        ...
        Route::resource('edition', EditionController::class)->names([
            'index'   => 'vendor.edition.index',
            'create'  => 'vendor.edition.create',
            'store'   => 'vendor.edition.store',
            'edit'    => 'vendor.edition.edit',
            'update'  => 'vendor.edition.update',
