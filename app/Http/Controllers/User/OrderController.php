            ...
            return DataTables::of($orders)
                ...
                ->addColumn('products', function ($order) {
                    if ($order->orders_products->count() > 0) {
                        ...
                        $html .= '<img src="' . config('app.book_covers_base_url', 'https://d3pq1zjqrptggt.cloudfront.net/book_covers/') . $productImage . '" alt="Product" style="width: 50px; height: 50px; object-fit: cover; border-radius: 4px; margin-right: 10px;">';
                        $html .= '<div>';
