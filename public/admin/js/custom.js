...
$(document).ready(function () {
    ...
    $(document).on("click", ".updateAdminStatus", function () {
        ...
        var updateUrl = $(this).data("url"); // full URL generated by route() in Blade
        ...
        $.ajax({
            ...
            type: "post",
            url: updateUrl, // uses project URL from Blade, works even in subfolder
    ...
    $(document).on("click", ".updatePublisherStatus", function () {
        // '.updatePublisherStatus' is the anchor link <a> CSS class    // This is the same as    $('.updatePublisherStatus').on('click', function() {
        var status = $(this).children("i").attr("status"); // Using HTML Custom Attributes
    ...
    $(document).on("click", ".updateSubscriberStatus", function () {
        ...
        $.ajax({
            ...
            success: function (resp) {
                if (resp.status == 1) {
                    $("#subscriber-" + subscriber_id + " i")
                        .removeClass("mdi-bookmark-outline")
                        .addClass("mdi-bookmark-check")
                        .attr("status", "Active");
                } else {
                    $("#subscriber-" + subscriber_id + " i")
                        .removeClass("mdi-bookmark-check")
