...
class RolesAndPermissionsSeeder extends Seeder
{
    public function run()
    {
        ...
        $modules = [
            ...
            'Catalogue' => ['view_sections', 'view_categories', 'add_categories', 'edit_categories', 'delete_categories', 'view_publishers', 'view_authors', 'view_subjects', 'view_languages', 'view_editions', 'view_coupons', 'view_requested_books', 'view_sell_old_books'],
            'Orders' => ['view_orders', 'edit_orders', 'delete_orders', 'update_order_status', 'update_order_item_status', 'view_sales_concept'],
            'Ratings' => ['view_ratings', 'update_ratings_status'],
